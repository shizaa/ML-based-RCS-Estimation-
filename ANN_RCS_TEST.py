...
# model_path = '/Users/Admin/Desktop/all shizz/ANN_RCSmodel.h5' 
...
# save_path = '/Users/Admin/Desktop/dataset/TEST_COMPFILES_PERFECT_PLOTS/ANN_RCS_test_compdata_C130_predicted.csv'
...
# Predict magnitude
predicted_magnitude = best_model.predict(features_scaled).flatten()
...
# Plotting (sort by incident angle for a smooth curve)
plot_data = combined_data[['Incident Angle', 'Predicted Magnitude']].sort_values(by='Incident Angle')
plt.plot(plot_data['Incident Angle'], plot_data['Predicted Magnitude'], label='Predicted Magnitude', marker='o')
plt.xlabel('Incident Angle (degrees)')
plt.ylabel('Magnitude')
plt.title('Magnitude vs Incident Angle (C130)')
